...
$currentSalaryDateUser = getCurrentSalaryDateUser($_SESSION["id"]);
$currentSalaryWeekUser = getCurrentSalaryWeekUser($_SESSION["id"]);
$countDateWorkMonthDistrict = getCountDateWorkMonthDistrict($_SESSION["id"],$months);
?>
...
$(document).ready(function() {
  ...
  events: 'api/load_calendar.php?users_id=<?php echo $_SESSION["id"]?>',
  });
});
</script>
        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title">ประวัติการทำงาน</h4>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      <?php 
                        $sumSalary = $currentUser["salary"] * $countDateWorkMonthDistrict["numDate"];
                      ?>
