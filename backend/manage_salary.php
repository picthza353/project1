                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">เงินเดือน</th>
                      <th></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <?php }else{?>
                      <?php foreach($allUser as $data){ ?>
                        <tr>
                          ...
                          <td>
                            <span class="text-xs font-weight-bold"><?php echo number_format($data["salary"]);?></span>
                          </td>
                          <td style="text-align: right;">
                            <a href="edit_salary.php?id=<?php echo $data["id"];?>" class="btn btn-outline-success">บันทึกค่าแรง</a>
                            <a href="detail_salary.php?id=<?php echo $data["id"];?>" class="btn btn-outline-info">คำนวนค่าแรง</a>
                          </td>
                        </tr>
                      <?php } ?>
                    <?php } ?>
