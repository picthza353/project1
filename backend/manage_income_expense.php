        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h4>จัดการข้อมูลรายรับ-รายจ่าย</h4>
            </div>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">ชื่อนามสกุล</th>
                      ...
                      <?php foreach($allProject as $data){ ?>
                        ...
                        <tr>
                          ...
                          <td style="text-align: right;">
                            <a href="edit_income.php?id=<?php echo $data["id"];?>" class="btn btn-outline-success">รายรับ</a>
                            <a href="edit_expense.php?id=<?php echo $data["id"];?>" class="btn btn-outline-danger">รายจ่าย</a>
                            <a href="detail_income_expense.php?id=<?php echo $data["id"];?>" class="btn btn-outline-info">สรุปผล</a>
                          </td>
                        </tr>
                      <?php } ?>
                    <?php } ?>
