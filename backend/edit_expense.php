  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <form name="prduct_detail_form" action="" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" class="form-control" name="ie_category" value="2">
        <div class="row">
          
          <div class="col-md-8">
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title">บันทึกรายจ่าย</h4>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="bmd-label-floating">รายละเอียดรายจ่าย<span style="color: red;"> *</span></label>
                ...
                <div align="center">
                  <input type="submit" name="submit" class="btn btn-success btn-round" value="บันทึกรายจ่าย">
